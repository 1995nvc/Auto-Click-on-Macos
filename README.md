...
## Tải ứng dụng có sẵn — không cần build

Nếu bạn đang dùng Mac Apple Silicon (`arm64`) như M1, M2, M3 hoặc M4, có thể tải trực tiếp file DMG đã build sẵn:

[![Download VIP Auto Bot V5.4 for macOS](https://img.shields.io/badge/Download-VIP%20Auto%20Bot%20V5.4-blue?style=for-the-badge&logo=apple)](https://github.com/1995nvc/Auto-Click-on-Macos/raw/refs/heads/main/Built/VIP-Auto-Bot-V5.4-macOS-arm64.dmg)

**Liên kết tải trực tiếp:**

```text
https://github.com/1995nvc/Auto-Click-on-Macos/raw/refs/heads/main/Built/VIP-Auto-Bot-V5.4-macOS-arm64.dmg
```

Sau khi tải xong:

1. Mở `VIP-Auto-Bot-V5.4-macOS-arm64.dmg`.
2. Kéo `VIP Auto Bot V5.4.app` vào thư mục **Applications**.
3. Mở ứng dụng từ **Applications**.
4. Cấp các quyền macOS được hướng dẫn tại [mục 7](#7-cấp-quyền-macos).

> File dựng sẵn này chỉ dành cho máy Mac Apple Silicon (`arm64`). Người dùng Mac Intel (`x86_64`) cần tự build theo hướng dẫn bên dưới hoặc tải bản Intel khi repository có phát hành.

> Nếu macOS chặn ứng dụng, nhấp chuột phải vào app, chọn **Open**, rồi xác nhận. Bạn cũng có thể vào **System Settings → Privacy & Security → Open Anyway**.
...
```text
VIP_Auto_Bot_V5_4_macOS_Crash_Fix/app.icns
```
